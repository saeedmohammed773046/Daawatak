...
import { Search, MailOpen, Sparkles, Send, Download, QrCode } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-bold sm:text-2xl">الدعوات</h1>
          <p className="mt-1 text-sm text-muted-foreground">أنشئ، صمم، وأرسل دعواتك الإلكترونية.</p>
        </div>
      ...
      {summary && (
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          <Card><CardContent className="p-4"><p className="text-2xl font-bold text-primary">{summary.ready}</p><p className="text-xs text-muted-foreground">جاهزة</p></CardContent></Card>
          ...
          <Card><CardContent className="p-4"><p className="text-2xl font-bold text-success">{summary.used}</p><p className="text-xs text-muted-foreground">مُستخدمة</p></CardContent></Card>
        </div>
      )}
